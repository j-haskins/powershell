...
$loopsToPreventIdle = 9999 # works for this loops to prevent the idle. Means: After 60++ Minutes (e.g.) the computer goes idle. If you are using this script permanently, set it to 9999 or something like that
